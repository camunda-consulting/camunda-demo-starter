...
const StartForm = require('src/main/js/reactjs/application/usecase/onboarding/components/home/StartForm');
const DetailForm = require('src/main/js/reactjs/application/usecase/onboarding/components/home/DetailForm');
const Info = require('src/main/js/reactjs/application/usecase/onboarding/components/home/Info');
const FilterBar = require('src/main/js/reactjs/application/usecase/onboarding/components/home/FilterBar');
  ...
  render(){
    ...
    return (
      <div>
        ...
        <FilterBar toggleForm={this.toggleForm} title="Mediny Home Sale"/>
