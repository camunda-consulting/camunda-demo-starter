...
const ServiceStartForm = require('src/main/js/reactjs/application/usecase/triage/components/home/ServiceSelectForm');
const ServiceForm = require('src/main/js/reactjs/application/usecase/triage/components/home/ServiceForm');
const ServiceDetailForm = require('src/main/js/reactjs/application/usecase/triage/components/home/ServiceDetailForm');
const ServiceSupplierForm = require('src/main/js/reactjs/application/usecase/triage/components/home/ServiceSupplierForm');
const Info = require('src/main/js/reactjs/application/usecase/triage/components/home/Info');
const FilterBar = require('src/main/js/reactjs/application/usecase/triage/components/home/FilterBar');
