...
@Profile("poc-es")
@Configuration
public class InterpretationEntityCreateConfig {

    private InterpretationRepository interpretationRepository;

    @Autowired
    public InterpretationEntityCreateConfig(InterpretationRepository interpretationRepository){
        this.interpretationRepository = interpretationRepository;
    }

    private final Logger LOGGER = Logger.getLogger(InterpretationEntityCreateConfig.class.getName());
