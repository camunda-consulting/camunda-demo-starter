package com.camunda.poc.starter.data.camunda.config;
...
@Profile("oauth")
@Configuration
public class CamundaEntityCreateConfig {

    private KaseRepository caseRepository;

    @Autowired
    public CamundaEntityCreateConfig(KaseRepository caseRepository){
